 ...
 */
    .factory('HttpService', function ($http) {
        ...
        httpService.myHttp = function (data, method, serverName) {
            ...
            // data.account_id = window.accountId;
            var param = {
                method: method,
 ...
 */
    .factory('DeviceGroups', function (HttpService) {
        ...
        var Group = {
             ...
             * 组通道控制
             */
            updChannel: function (group_guid, group_addr, group_value,gatewayId) {
                var param = {
                    table_group: [
                        {
 ...
 */
    .factory('Users', function (HttpService) {
        ...
        return {
            ...
            newUser: function (param) {
                var newUserData = {
                    "user_name": param.newUserName,
                    "password": param.newUserPassword,
                    "e_mail": param.newUserEmail,
                    "phone": param.newUserPhone,
                    "country": param.country.countryId,
                    "father_user": window.userId
                    // "father_user" : "xxxxxxxxx"
                };
                console.log("新建用户传参", newUserData);
                return HttpService.myHttp(newUserData, 'POST', 'user').then(function (data) {
                    return data;
                });
            }
        };
